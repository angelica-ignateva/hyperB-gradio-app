...
with header:
    ...
    with header.expander("HyperBuilding B🔽", expanded=True):
        st.markdown(
...
projectID = "daeb18ed0a"

# Get projects
project = client.project.get(project_id=projectID)
print(f'Project: {project.name}')

# Get models
project = client.project.get_with_models(project_id=projectID, models_limit=20)
